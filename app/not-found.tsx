  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-6">
      <div className="w-full max-w-xl bg-white border rounded-2xl shadow-xl p-8 text-center">
        <div className="mx-auto mb-4 w-16 h-16 rounded-full bg-brand-purple/5 flex items-center justify-center">
        ...
        <div className="mt-6 flex items-center justify-center gap-3">
          <Link href="/" className="px-4 py-2 bg-brand-purple text-white rounded-lg flex items-center gap-2">
