    ...
    <div className="min-h-screen bg-background flex flex-col items-center p-4 relative overflow-x-hidden">
      ...
      <div className="max-w-4xl w-full mx-auto my-auto text-center z-10 space-y-12">
        ...
        >
          ...
          <Link
            href="https://play.google.com/store/apps/details?id=com.firgomart.twa"
            target="_blank"
            className="group relative w-full max-w-xs p-6 rounded-3xl bg-[var(--card-bg)] backdrop-blur-sm border border-[var(--card-border)] shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300"
          >
