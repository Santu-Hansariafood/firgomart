  ...
  try {
    ...
    try {
      ...
      const html = getCommonEmailTemplate({
        ...
        greeting: "Hi there",
        message: "Thank you for signing up with <strong>FirgoMart</strong>. To keep your account secure, we need to verify your email address before you can continue.",
        otp: code,
        expiryText: "This code is valid for 10 minutes.",
        warningText: "If you did not request this email, you can safely ignore it. Your customer account will not be created without completing this verification."
      })
