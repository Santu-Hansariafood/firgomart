    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-background/95 backdrop-blur-2xl text-foreground rounded-2xl sm:rounded-3xl max-w-5xl w-full max-h-[90vh] overflow-y-auto flex flex-col border border-foreground/10 shadow-2xl relative"
        >
          ...
          <div className="sticky top-0 bg-background/80 backdrop-blur-xl border-b border-foreground/5 px-4 py-3 sm:px-6 sm:py-4 flex items-center justify-between z-30">
            <h2 className="text-base sm:text-lg font-semibold truncate pr-4 text-gray-900 dark:text-gray-50">{product.name}</h2>
            <div className="flex items-center gap-2 sm:gap-3">
              <button
                onClick={handleShare}
                className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-foreground/5 dark:bg-white/10 hover:bg-foreground/10 dark:hover:bg-white/20 transition-all hover:scale-105"
                title="Share"
              >
                <Share2 className="w-4 h-4 sm:w-5 sm:h-5 text-foreground/70 dark:text-white/70" />
              </button>
              <button
                onClick={toggleSave}
                disabled={saving}
              ...
              >
                <Heart className={`w-4 h-4 sm:w-5 sm:h-5 transition-colors ${isSaved ? 'fill-red-500 text-red-500' : 'text-foreground/70 dark:text-white/70'}`} />
              </button>
              <button
                onClick={onClose}
                className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-full bg-foreground/5 dark:bg-white/10 hover:bg-red-500/10 hover:text-red-500 transition-all hover:scale-105 hover:rotate-90"
                title="Close"
              >
                <X className="w-4 h-4 sm:w-5 sm:h-5 text-foreground dark:text-white" />
              </button>
            </div>
          </div>

          <div className="p-3 sm:p-4 md:p-8 overflow-y-auto custom-scrollbar relative">
